...
df = pd.read_csv("C:/Users/Elsayed Hassan/.spyder-py3/autosave/International_Report_Departures.csv").head(5000)
...
newdf = pd.get_dummies(df, columns=[col for col , col_type in column_types.items() if col_type == "categorical"])
